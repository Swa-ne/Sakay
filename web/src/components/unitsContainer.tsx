...
import { Car, SquareParking, TimerReset } from 'lucide-react';
        ...
        <div className='w-full h-20 flex bg-background rounded-md space-x-1 cursor-pointer'>
            ...
            <div className='flex w-4/5 space-x-1.5'>
                <div className='w-2/3'>
                    ...
                    <p className='text-sm line-clamp-2'>{getNearestDestination(bus.latitude, bus.longitude)}</p>
                </div>
                <div className='w-1/3 flex flex-col items-center justify-center'>
                    <div className='flex items-center py-1 rounded-sm text-xs justify-center self-stretch space-x-2'>
                        <div className=' flex items-center bg-blue-100 px-1 py-1 text-blue-700 rounded-sm text-xs justify-center self-stretch'>{getNearestDestination(bus.latitude, bus.longitude) != 'LDTC Parking Terminal' ? <Car width={14} height={14} /> : <SquareParking width={14} height={14} />}</div>
