...
import 'package:sakay_app/presentation/screens/admin/map.dart'; // Import the Map widget
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Surveillance(),
      routes: {
        '/map': (context) => const Map(), // Navigate to the Map screen
      },
    );
  }
}
...
class Surveillance extends StatefulWidget {
  ...
  @override
  _SurveillanceState createState() => _SurveillanceState();
}
